...
<head>
    ...
    <title>Sage AI - Your Intelligent Assistant</title>
...
<body class="bg-white dark:bg-[#181818] text-gray-900 dark:text-gray-100 transition-colors duration-200">
    <div class="max-w-4xl mx-auto p-4 sm:p-6">
        ...
        <div class="mb-6 text-center">
            ...
            <p class="text-gray-600 dark:text-gray-400 text-sm sm:text-base mb-1">
                Your intelligent assistant for any question
            </p>
    ...
    <script>
        ...
        window.Poe.registerHandler("sage-handler", (result, context) => {
        ...
        async function sendMessage() {
            ...
            try {
                await window.Poe.sendUserMessage(`@Claude-Sonnet-4.5 ${text}`, {
                    handler: "sage-handler",
                    stream: true,
                    openChat: false,
